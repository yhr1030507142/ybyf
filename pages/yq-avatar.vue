<template name="yq-avatar">
	<view>
		...
		<cover-view class="oper-wrapper" :style="{display: styleDisplay}">
			<cover-view class="oper">
				<cover-view class="btn-wrapper" v-if="showOper">
					<cover-view @click="fSelect"  hover-class="hover" :style="{width: btnWidth}"><cover-view>重选</cover-view></cover-view>
					<cover-view @click="fClose"  hover-class="hover" :style="{width: btnWidth}"><cover-view>关闭</cover-view></cover-view>
					<cover-view @click="fRotate"  hover-class="hover" :style="{width: btnWidth, display: btnDsp}"><cover-view>旋转</cover-view></cover-view>
					<cover-view @click="fPreview" hover-class="hover" :style="{width: btnWidth}"><cover-view>预览</cover-view></cover-view>
					<cover-view @click="fUpload"  hover-class="hover" :style="{width: btnWidth}"><cover-view>上传</cover-view></cover-view>
				</cover-view>
				<cover-view class="clr-wrapper" v-else>
					...
					<cover-view @click="fPrvUpload"  hover-class="hover" :style="{width: btnWidth}"><cover-view>上传</cover-view></cover-view>
				</cover-view>
			</cover-view>
		</cover-view> 
	</view>
